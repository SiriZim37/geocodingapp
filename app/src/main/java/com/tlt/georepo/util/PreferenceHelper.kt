...
//     fun setForgotPref(mContext: Context, isForgot: Boolean) {
//        val mPreferences = PreferenceManager.getDefaultSharedPreferences(mContext)
//        mPreferences.edit().putBoolean("forgot", isForgot).apply()
//    }
//
//    fun getForgotPref(mContext: Context): Boolean {
//        val mPreferences = PreferenceManager.getDefaultSharedPreferences(mContext)
//        return mPreferences.getBoolean("forgot", false)
//    }
//
//    fun deleteForgot(mContext: Context) {
//        val mPreferences = PreferenceManager.getDefaultSharedPreferences(mContext)
//        mPreferences.edit().remove("forgot").commit()
//    }
}