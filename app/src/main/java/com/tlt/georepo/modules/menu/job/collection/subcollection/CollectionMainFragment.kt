...
import com.tlt.georepo.modules.menu.job.collection.common.CollectionGuarantorAdapter
...
class CollectionMainFragment : BaseFragment(), OnMapReadyCallback {
   ...
   var ProfileListData : List<CollectionProfileItem>? = null
            ...
            if (ProfileListData!!.count()>0){
                ...
                if(items.gUARANTOR!!.count() > 0) {
                    if (items.gUARANTOR!!.isNotEmpty()) {
                        ...
                        recycler_view.adapter = CollectionGuarantorAdapter(onGuarantorListener)
                        val adapter = recycler_view.adapter as CollectionGuarantorAdapter
    ...
    private val onGuarantorListener = object : CollectionGuarantorAdapter.Listener {
    }
    ...
    companion object {
        ...
        fun newInstance() = CollectionMainFragment().apply {
