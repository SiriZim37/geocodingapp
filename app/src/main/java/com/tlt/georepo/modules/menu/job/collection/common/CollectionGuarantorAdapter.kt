...
class CollectionGuarantorAdapter (private val listener: Listener) : RecyclerView.Adapter<CollectionGuarantorAdapter.ViewHolder>() {

    private val items = ArrayList<CollectionProfileGuarantorItem>()
    ...
    fun updateItems(items: List<CollectionProfileGuarantorItem>) {
        this.items.clear()
    ...
    class ViewHolder(private val view: View,
        ...
        fun bindByType1(item: CollectionProfileGuarantorItem) {
