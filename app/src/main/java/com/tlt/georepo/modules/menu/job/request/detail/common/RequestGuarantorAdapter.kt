...
class RequestGuarantorAdapter (private val listener: Listener) : RecyclerView.Adapter<RequestGuarantorAdapter.ViewHolder>() {

    private val items = ArrayList<RequestProfileGuarantorItem>()
    ...
    fun updateItems(items: List<RequestProfileGuarantorItem>) {
        this.items.clear()
    ...
    class ViewHolder(private val view: View,
        ...
        fun bindByType1(item: RequestProfileGuarantorItem) {
