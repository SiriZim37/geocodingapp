...
import com.tlt.georepo.modules.menu.notify.common.NotiJobGuarantorAdapter
...
class NotiJobMainFragment : BaseFragment() , OnMapReadyCallback {
            ...
            if (ProfileListData!!.count()>0){
                ...
                if(items.gUARANTOR!!.count() > 0) {
                    if (items.gUARANTOR!!.isNotEmpty()) {
                        ...
                        recycler_view.adapter = NotiJobGuarantorAdapter(onGuarantorListener)
                        val adapter = recycler_view.adapter as NotiJobGuarantorAdapter
    ...
    private val onGuarantorListener = object : NotiJobGuarantorAdapter.Listener {
    }
...
//        map.uiSettings.isMapToolbarEnabled = false
    ...
    companion object {
        ...
        fun newInstance() = NotiJobMainFragment().apply {
