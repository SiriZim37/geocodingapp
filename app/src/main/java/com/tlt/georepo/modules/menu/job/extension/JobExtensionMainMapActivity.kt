package com.tlt.georepo.modules.menu.job.extension
...
import com.tlt.georepo.modules.location.main.JobExtensionLocationFragment
...
class JobExtensionMainMapActivity : BaseActivity(),
    ...
    private fun initInstances() {
        ...
        isSavedInstanceStateNotNull().ifFalse {
            loadMultipleRootFragment(content_container.id, defaultMenuPosition,
                findFragment(JobExtensionLocationFragment::class.java)
                    ?: JobExtensionLocationFragment.newInstance()
            )
        }
    ...
    companion object {
        ...
        fun Open(context: Context) {
            val intent = Intent(context, JobExtensionMainMapActivity::class.java).apply {
