...
import com.tlt.georepo.modules.menu.job.extension.common.ExtensionGuarantorAdapter
...
class ExtensionMainFragment : BaseFragment(), OnMapReadyCallback {
   ...
   var ProfileListData : List<ExtensionProfileItem>? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_extension_main, container, false)
    }
            ...
            if (ProfileListData!!.count()>0){
                ...
                if(items.gUARANTOR!!.count() > 0) {
                    if (items.gUARANTOR!!.isNotEmpty()) {
                        ...
                        recycler_view.adapter = ExtensionGuarantorAdapter(onGuarantorListener)
                        val adapter = recycler_view.adapter as ExtensionGuarantorAdapter
    ...
    private val onGuarantorListener = object : ExtensionGuarantorAdapter.Listener {
    }
    ...
    companion object {
        ...
        fun newInstance() = ExtensionMainFragment().apply {
