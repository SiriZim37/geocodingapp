    ...
    fun parse(jObject: JSONObject): List<List<HashMap<String, String>>> {
        ...
        try {
            ...
            for (i in 0..jRoutes.length() - 1) {
                ...
                var distance = ""
                var duration = ""
                distance = ((jLegs.get(0) as JSONObject).get("distance") as JSONObject).get("text") as String
                duration =  ((jLegs.get(0) as JSONObject).get("duration") as JSONObject).get("text") as String
                /** Traversing all legs  */
